<div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
    ...
    <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="h-32 md:h-auto md:w-1/2">
            ...
            <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="{{ asset('assets/images/create-account-office.jpeg') }}" alt="Office" />

            <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="{{ asset('assets/images/create-account-office-dark.jpeg') }}" alt="Office" />
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <div class="w-full">
                ...
                <a href="./login.html" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"> Create account</a>
                ...
                <p class="mt-4">
                    ...
                    <a href="./login.html" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">
